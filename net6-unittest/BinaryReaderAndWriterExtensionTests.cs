...
{
	public static class BinaryReaderAndWriterExtensionTests
	{
		...
		[Fact]
		public static void guid() => testBody(BinaryWriterExtensions.Write, BinaryReaderExtension.ReadGuid, Guid.NewGuid());

		[Fact]
		public static void datetime() => testBody(BinaryWriterExtensions.Write, BinaryReaderExtension.ReadDateTime, DateTime.Now);

		[Fact]
		public static void timespan() => testBody(BinaryWriterExtensions.Write, BinaryReaderExtension.ReadTimeSpan, DateTime.Now - new DateTime(2020, 01, 01));

		[Fact]
		public static void binarydata() => testBody(BinaryWriterExtensions.WriteBinaryData, BinaryReaderExtension.ReadBinaryData, Guid.NewGuid().ToByteArray(), (a, b) => a.SequenceEquals(b));

		[Fact]
		public static void trybinarydat_Negative()
		{
			testBody((writer, _) => writer.Write(-1), reader => reader.TryReadBinaryData(out var _), equality: (a, _) => !a);
		}

		[Fact]
		public static void trybinarydat_ToBig()
		{
			testBody((writer, _) => writer.WriteBinaryData(new byte[100]), reader => reader.TryReadBinaryData(out var _, 10), equality: (a, _) => !a);
		}

		[Fact]
		public static void trybinarydat_Working()
		{
		...
		[Fact]
		public static void nulldecimal()
		{
		...
		[Fact]
		public static void trynullbindat()
		{
		...
		[Fact]
		public static void nulldatetime()
		{
		...
		[Fact]
		public static void nulltimespan()
		{
